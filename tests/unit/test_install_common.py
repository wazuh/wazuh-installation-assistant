...
class TestInstallCommonDownloadArtifactURLs:
    ...
    def test_production_mode_constructs_correct_url(self, tmp_path):
        """Production mode: URL should be https://bucket/production/1.x/artifact_urls_5.0.0.yaml"""
    ...
    def test_prerelease_mode_constructs_correct_url(self, tmp_path):
        """Pre-release mode: URL should be https://bucket/pre-release/1.x/artifact_urls_5.0.0-rc1.yaml"""
