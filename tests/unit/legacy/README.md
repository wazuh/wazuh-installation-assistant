# Legacy Unit Tests (Bach / Docker)

> **These tests are no longer executed.** The active unit test suite has been rewritten in Python pytest.
> See [`../README.md`](../README.md) for current usage instructions.

---

This directory preserves the original Bach/Docker-based test infrastructure for historical reference.

---

# Original Instructions

This document provides instructions on how to run the legacy unit tests using Docker.
