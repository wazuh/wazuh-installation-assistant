...
class TestChecksHealth:
    ...
    def test_fail_aio_1_core(self):
        assert_failure(self._run({"AIO": "1", "cores": "1", "ram_gb": "15700"}))

    def test_fail_aio_insufficient_ram(self):
        assert_failure(self._run({"AIO": "1", "cores": "8", "ram_gb": "7700"}))

    def test_success_aio_8_cores_16gb(self):
        assert_success(self._run({"AIO": "1", "cores": "8", "ram_gb": "15700"}))

    def test_fail_indexer_1_core(self):
        assert_failure(self._run({"indexer": "1", "cores": "1", "ram_gb": "7700"}))
    ...
    def test_success_indexer_4_cores_8gb(self):
        assert_success(self._run({"indexer": "1", "cores": "4", "ram_gb": "7700"}))
    ...
    def test_fail_wazuh_1_core(self):
        assert_failure(self._run({"wazuh": "1", "cores": "1", "ram_gb": "7700"}))
    ...
    def test_success_wazuh_4_cores_8gb(self):
        assert_success(self._run({"wazuh": "1", "cores": "4", "ram_gb": "7700"}))
