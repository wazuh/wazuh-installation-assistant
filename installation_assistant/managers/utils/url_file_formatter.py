...
from installation_assistant.utils import ComponentArch, PackageType
...
def get_component_packages_by_arch(component_packages: list[str]) -> dict:
    ...
    for package_url in component_packages:
        for package_arch in ComponentArch:
...
def get_component_packages_by_type(component_packages: dict) -> dict:
    ...
    """
    component_type = {package_type.name.lower(): {} for package_type in PackageType}
