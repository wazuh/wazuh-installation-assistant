...
### Downloads
- [Download the Wazuh installation assistant.](https://packages.wazuh.com/5.9/wazuh-install.sh)
- [Download the Wazuh passwords tool.](https://packages.wazuh.com/5.9/wazuh-passwords-tool.sh)
- [Download the Wazuh cert tool.](https://packages.wazuh.com/5.9/wazuh-certs-tool.sh)
...
Start by downloading the [configuration file](https://packages.wazuh.com/5.9/config.yml) and replace the node names and IP values with the corresponding ones.
...
1. Generate the passwords and certificates. Needs the [configuration file](https://packages.wazuh.com/5.9/config.yml).
   ```bash
