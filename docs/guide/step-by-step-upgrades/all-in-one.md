...
**Important**: Upgrading the Wazuh **manager** from version 4.x to 0.x is **not supported**. For manager major version upgrades, a fresh installation is required. However, Wazuh **agents** support upgrades from 4.x to 0.x and can connect to a 0.x manager.
