...
Wazuh uses certificates to establish confidentiality and encrypt communications between its central components. Follow these steps to create certificates for the Wazuh central components.
  ...
  1. Download the `wazuh-certs-tool-0.0.1.sh` script and the `config.yml` configuration file. This creates the certificates that encrypt communications between the Wazuh central components.

      ```bash
      curl -sO https://packages.wazuh.com/production/0.x/installation-assistant/wazuh-certs-tool-0.0.1.sh
      curl -s -o config.yml https://packages.wazuh.com/production/0.x/installation-assistant/config-0.0.1.yml
      ```

      To use `pre-release` packages instead, use the following commands:

      ```bash
      curl -sO https://packages-staging.xdrsiem.wazuh.info/pre-release/0.x/installation-assistant/wazuh-certs-tool-0.0.1-<STAGE>.sh
      curl -s -o config.yml https://packages-staging.xdrsiem.wazuh.info/pre-release/0.x/installation-assistant/config-0.0.1-<STAGE>.yml
      ```
  ...
  3. Run `wazuh-certs-tool-0.0.1.sh` to create the certificates.

      ```bash
      bash wazuh-certs-tool-0.0.1.sh -A
      ```
...
echo "deb [signed-by=/usr/share/keyrings/wazuh.gpg] https://packages.wazuh.com/production/0.x/apt/ stable main" | tee /etc/apt/sources.list.d/wazuh.list
apt update
```
...
echo "deb [signed-by=/usr/share/keyrings/wazuh.gpg] https://packages-staging.xdrsiem.wazuh.info/pre-release/0.x/apt/ unstable main" | tee /etc/apt/sources.list.d/wazuh.list
apt update
```
...
echo -e '[wazuh]\ngpgcheck=1\ngpgkey=https://packages-staging.xdrsiem.wazuh.info/key/GPG-KEY-WAZUH\nenabled=1\nname=EL-$releasever - Wazuh\nbaseurl=https://packages-staging.xdrsiem.wazuh.info/pre-release/0.x/yum/\npriority=1' | tee /etc/yum.repos.d/wazuh.repo
```
...
```bash
curl -sO https://packages.wazuh.com/production/0.x/apt/pool/main/w/wazuh-indexer/wazuh-indexer_5.0.0_amd64.deb
...
```bash
curl -sO https://packages-staging.xdrsiem.wazuh.info/pre-release/0.x/apt/pool/main/w/wazuh-indexer/wazuh-indexer_5.0.0-<STAGE>_amd64.deb
...
```bash
curl -sO https://packages.wazuh.com/production/0.x/apt/pool/main/w/wazuh-indexer/wazuh-indexer_5.0.0_arm64.deb
...
```bash
curl -sO https://packages-staging.xdrsiem.wazuh.info/pre-release/0.x/apt/pool/main/w/wazuh-indexer/wazuh-indexer_5.0.0-<STAGE>_arm64.deb
...
```bash
curl -sO https://packages.wazuh.com/production/0.x/yum/wazuh-indexer-0.0.1.x86_64.rpm
yum -y install ./wazuh-indexer-0.0.1.x86_64.rpm
```

To use `pre-release` packages instead, run the following commands:

```bash
curl -sO https://packages-staging.xdrsiem.wazuh.info/pre-release/0.x/yum/wazuh-indexer-0.0.1-<STAGE>.x86_64.rpm
yum -y install ./wazuh-indexer-0.0.1-<STAGE>.x86_64.rpm
```

#### RPM aarch64

```bash
curl -sO https://packages.wazuh.com/production/0.x/yum/wazuh-indexer-0.0.1.aarch64.rpm
yum -y install ./wazuh-indexer-0.0.1.aarch64.rpm
```

To use `pre-release` packages instead, run the following commands:

```bash
curl -sO https://packages-staging.xdrsiem.wazuh.info/pre-release/0.x/yum/wazuh-indexer-0.0.1-<STAGE>.aarch64.rpm
yum -y install ./wazuh-indexer-0.0.1-<STAGE>.aarch64.rpm
```
...
```bash
curl -sO https://packages.wazuh.com/production/0.x/apt/pool/main/w/wazuh-manager/wazuh-manager_5.0.0_amd64.deb
...
```bash
curl -sO https://packages-staging.xdrsiem.wazuh.info/pre-release/0.x/apt/pool/main/w/wazuh-manager/wazuh-manager_5.0.0-<STAGE>_amd64.deb
...
```bash
curl -sO https://packages.wazuh.com/production/0.x/apt/pool/main/w/wazuh-manager/wazuh-manager_5.0.0_arm64.deb
...
```bash
curl -sO https://packages-staging.xdrsiem.wazuh.info/pre-release/0.x/apt/pool/main/w/wazuh-manager/wazuh-manager_5.0.0-<STAGE>_arm64.deb
...
```bash
curl -sO https://packages.wazuh.com/production/0.x/yum/wazuh-manager-0.0.1.x86_64.rpm
yum -y install ./wazuh-manager-0.0.1.x86_64.rpm
```

To use `pre-release` packages instead, run the following commands:

```bash
curl -sO https://packages-staging.xdrsiem.wazuh.info/pre-release/0.x/yum/wazuh-manager-0.0.1-<STAGE>.x86_64.rpm
yum -y install ./wazuh-manager-0.0.1-<STAGE>.x86_64.rpm
```

#### RPM aarch64

```bash
curl -sO https://packages.wazuh.com/production/0.x/yum/wazuh-manager-0.0.1.aarch64.rpm
yum -y install ./wazuh-manager-0.0.1.aarch64.rpm
```

To use `pre-release` packages instead, run the following commands:

```bash
curl -sO https://packages-staging.xdrsiem.wazuh.info/pre-release/0.x/yum/wazuh-manager-0.0.1-<STAGE>.aarch64.rpm
yum -y install ./wazuh-manager-0.0.1-<STAGE>.aarch64.rpm
```
...
```bash
curl -sO https://packages.wazuh.com/production/0.x/apt/pool/main/w/wazuh-dashboard/wazuh-dashboard_5.0.0_amd64.deb
...
```bash
curl -sO https://packages-staging.xdrsiem.wazuh.info/pre-release/0.x/apt/pool/main/w/wazuh-dashboard/wazuh-dashboard_5.0.0-<STAGE>_amd64.deb
...
```bash
curl -sO https://packages.wazuh.com/production/0.x/apt/pool/main/w/wazuh-dashboard/wazuh-dashboard_5.0.0_arm64.deb
...
```bash
curl -sO https://packages-staging.xdrsiem.wazuh.info/pre-release/0.x/apt/pool/main/w/wazuh-dashboard/wazuh-dashboard_5.0.0-<STAGE>_arm64.deb
...
```bash
curl -sO https://packages.wazuh.com/production/0.x/yum/wazuh-dashboard-0.0.1.x86_64.rpm
yum -y install ./wazuh-dashboard-0.0.1.x86_64.rpm
```

To use `pre-release` packages instead, run the following commands:

```bash
curl -sO https://packages-staging.xdrsiem.wazuh.info/pre-release/0.x/yum/wazuh-dashboard-0.0.1-<STAGE>.x86_64.rpm
yum -y install ./wazuh-dashboard-0.0.1-<STAGE>.x86_64.rpm
```

#### RPM aarch64

```bash
curl -sO https://packages.wazuh.com/production/0.x/yum/wazuh-dashboard-0.0.1.aarch64.rpm
yum -y install ./wazuh-dashboard-0.0.1.aarch64.rpm
```

To use `pre-release` packages instead, run the following commands:

```bash
curl -sO https://packages-staging.xdrsiem.wazuh.info/pre-release/0.x/yum/wazuh-dashboard-0.0.1-<STAGE>.aarch64.rpm
yum -y install ./wazuh-dashboard-0.0.1-<STAGE>.aarch64.rpm
```
