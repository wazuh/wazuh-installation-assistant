...
## Download and run the Wazuh installation assistant
   ...
   >
   > ```bash
   > curl -sO https://packages-staging.xdrsiem.wazuh.info/pre-release/5.x/installation-assistant/wazuh-install-5.9.9-<STAGE>.sh && sudo bash ./wazuh-install-5.9.9-<STAGE>.sh -a -d pre-release
   > ```
