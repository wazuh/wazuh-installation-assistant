...
3. The file related to the Certs Tool will be generated in the same path where the `builder.sh` script is located. This file will be named `wazuh-certs-tool-0.0.1.sh`.
...
3. The file related to the Passwords Tool will be generated in the same path where the `builder.sh` script is located. This file will be named `wazuh-passwords-tool-0.0.1.sh`.
...
3. The file related to the Installation Assistant will be generated in the same path where the `builder.sh` script is located. This file will be named `wazuh-install-0.0.1.sh`.
