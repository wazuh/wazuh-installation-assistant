...
Wazuh central components use different types of users for their operation, such as Wazuh indexer users, Wazuh manager users, the `wazuh-passwords-tool-4.14.8.sh` script is used to manage passwords related to Wazuh internal users. This tool allows users to create, update, and manage passwords securely for the different Wazuh internal users.
