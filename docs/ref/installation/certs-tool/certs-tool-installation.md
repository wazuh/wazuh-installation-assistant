...
The Certs Tool can be installed by downloading the `wazuh-certs-tool-10.9.9.sh` script from the Wazuh packages repository. You can do this by running the following command:
