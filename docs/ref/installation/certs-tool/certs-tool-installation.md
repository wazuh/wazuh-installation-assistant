...
The Certs Tool can be installed by downloading the `wazuh-certs-tool-5.0.1.sh` script from the Wazuh packages repository. You can do this by running the following command:
