...
The Installation Assistant can be installed by downloading the `wazuh-install-5.0.0-1.sh` script from the Wazuh packages repository. You can do this by running the following command:
