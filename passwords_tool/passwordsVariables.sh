...
save_failed=""
indexer_accounts=("admin" "kibanaserver" "wazuh-manager")
api_accounts=("wazuh" "wazuh-wui")
hash_tool="/usr/share/wazuh-indexer/plugins/opensearch-security/tools/hash.sh"
rbac_control="/var/wazuh-manager/bin/rbac_control"
dashboard_keystore="/usr/share/wazuh-dashboard/bin/opensearch-dashboards-keystore"
